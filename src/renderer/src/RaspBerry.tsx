  ...
  return (
    <>
      <div className="w-screen h-screen flex flex-col m-0 p-0 justify-center overflow-hidden ">
        {load && <Loading />}
        <div className="w-full h-[100px] z-10 animate-fade animate-once animate-duration-5000 animate-ease-in">
          <NavbarRasp />
        </div>
        <div className="w-full h-full z-9 flex justify- p-0 m-0 items-center space-x-5 bg-[#fff] object-fill overflow-hidden ">
          ...
          <div className="absolute bg-[#DC094155] w-[180vh] h-[85vh] rounded-[10px]">
            <Outlet />
          </div>
        </div>
      </div>
