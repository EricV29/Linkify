    ...
    <>
      ...
      <div className="w-full h-full flex flex-col m-0 p-5 justify-start items-center overflow-y-scroll">
        ...
        <div className="flex flex-col justify-start p-5 w-full">
          <h2 className="text-[#00989E] font-bold text-[25px]">Arduino</h2>
          <div className="flex space-x-5 items-center pl-7 text-[20px]">
            <Icon icon="solar:box-bold" color="#ccfafc" width={40} />
            ...
            <Icon icon="fluent-mdl2:date-time" color="#ccfafc" width={40} />
          ...
          <h2 className="text-[#00989E] font-bold text-[25px]">Alumno</h2>
          <div className="flex space-x-5 items-center pl-7 mb-3 text-[20px]">
            <Icon icon="teenyicons:id-solid" color="#ccfafc" width={40} />
          ...
          <div className="flex space-x-5 items-center pl-7 text-[20px] mb-5">
            <Icon icon="mage:robot-fill" color="#ccfafc" width={40} />
          ...
          <div className="flex space-x-5 items-center pl-7 text-[20px] mb-5">
            <Icon icon="mi:email" color="#ccfafc" width={40} />
            ...
            />
            <Button
              className="w-[160px] bg-[#00989E] text-[#fff] font-bold"
              variant="shadow"
              color="primary"
              onClick={addUser}
            >
